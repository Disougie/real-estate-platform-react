...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.PageResponseAppUserResponse();
  });
  ...
  describe('PageResponseAppUserResponse', function() {
    it('should create an instance of PageResponseAppUserResponse', function() {
      // uncomment below and update the code to test PageResponseAppUserResponse
      //var instance = new ApiClient.PageResponseAppUserResponse();
      //expect(instance).to.be.a(ApiClient.PageResponseAppUserResponse);
    });
