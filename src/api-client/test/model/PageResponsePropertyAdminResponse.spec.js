...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.PageResponsePropertyAdminResponse();
  });
  ...
  describe('PageResponsePropertyAdminResponse', function() {
    it('should create an instance of PageResponsePropertyAdminResponse', function() {
      // uncomment below and update the code to test PageResponsePropertyAdminResponse
      //var instance = new ApiClient.PageResponsePropertyAdminResponse();
      //expect(instance).to.be.a(ApiClient.PageResponsePropertyAdminResponse);
    });
