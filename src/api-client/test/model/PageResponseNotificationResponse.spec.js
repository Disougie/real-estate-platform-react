...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.PageResponseNotificationResponse();
  });
  ...
  describe('PageResponseNotificationResponse', function() {
    it('should create an instance of PageResponseNotificationResponse', function() {
      // uncomment below and update the code to test PageResponseNotificationResponse
      //var instance = new ApiClient.PageResponseNotificationResponse();
      //expect(instance).to.be.a(ApiClient.PageResponseNotificationResponse);
    });
