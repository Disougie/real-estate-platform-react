...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.PropertyDetailedResponse();
  });
  ...
  describe('PropertyDetailedResponse', function() {
    it('should create an instance of PropertyDetailedResponse', function() {
      // uncomment below and update the code to test PropertyDetailedResponse
      //var instance = new ApiClient.PropertyDetailedResponse();
      //expect(instance).to.be.a(ApiClient.PropertyDetailedResponse);
    });
    ...
    it('should have the property imagesUrls (base name: "imagesUrls")', function() {
      // uncomment below and update the code to test the property imagesUrls
      //var instance = new ApiClient.PropertyDetailedResponse();
      //expect(instance).to.be();
    });
