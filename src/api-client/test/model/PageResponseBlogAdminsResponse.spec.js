...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.PageResponseBlogAdminsResponse();
  });
  ...
  describe('PageResponseBlogAdminsResponse', function() {
    it('should create an instance of PageResponseBlogAdminsResponse', function() {
      // uncomment below and update the code to test PageResponseBlogAdminsResponse
      //var instance = new ApiClient.PageResponseBlogAdminsResponse();
      //expect(instance).to.be.a(ApiClient.PageResponseBlogAdminsResponse);
    });
