...
(function(root, factory) {
  ...
  describe('Review', function() {
    it('should create an instance of Review', function() {
      ...
      //var instance = new ApiClient.Review();
      //expect(instance).to.be.a(ApiClient.Review);
    });
    ...
    it('should have the property noOfReview (base name: "noOfReview")', function() {
      // uncomment below and update the code to test the property noOfReview
      //var instance = new ApiClient.Review();
      //expect(instance).to.be();
    });
