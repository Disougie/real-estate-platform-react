...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.ChangeInfoControllerApi();
  });
  ...
  describe('ChangeInfoControllerApi', function() {
    ...
    describe('changePhone', function() {
      it('should call changePhone successfully', function(done) {
        //uncomment below and update the code to test changePhone
        //instance.changePhone(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
