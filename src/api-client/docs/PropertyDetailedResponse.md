...
**decription** | **string** |  | [optional] [default to undefined]
...
**imagesUrls** | **Array&lt;string&gt;** |  | [optional] [default to undefined]
**review** | [**Review**](Review.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PropertyDetailedResponse } from './api';

const instance: PropertyDetailedResponse = {
    id,
    title,
    ownerName,
    decription,
